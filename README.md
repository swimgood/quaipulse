...
- Polls `GET https://quaiscan.io/api/v2/transactions?filter=validated` every 5 seconds
...
- If more than ~14 new transactions land in one poll (a busy moment), pulses are capped and
